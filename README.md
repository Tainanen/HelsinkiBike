...
* Testing and security: For making an application that's truly tested and secured, I need to learn more about these subjects.
* Overall the designing of an application to make it as user-friendly and coherent as possible would be my first step when I start creating my next project.
